...
public class TournamentControllerTest {
    ...
    public void testGetRoundData_WhenTournamentIsOver_AndNotCalculated() {
        ...
        verify(tournamentService, times(1)).updateResults(lastRound);
    ...
    public void testGetRoundData_WhenTournamentIsOver_AndCalculated() {
        ...
        verify(tournamentService, never()).updateResults(any());
    ...
    public void testGetStandings() {
        ...
        when(tournamentService.getSortedUsers(tournamentId)).thenReturn(mockUsers);
